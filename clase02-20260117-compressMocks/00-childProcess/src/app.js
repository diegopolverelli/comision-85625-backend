...
app.get('/calculo2', (req, res) => {
    ...
    let childProcess=fork("./src/calculo.js")
    childProcess.send(`Soy el Server, con pid ${process.pid}, y necesito que te ejecutes...!!!`)

    childProcess.on("message", datos=>{
        if(datos.type=="resultado"){
            let resultado = `El resultado es ${datos.result}`
